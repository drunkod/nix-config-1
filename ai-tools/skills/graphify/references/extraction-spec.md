...
Then write the JSON to disk at this exact absolute path. Do not use a relative path; agent tool working directories may be undefined and the file can be silently lost:
CHUNK_PATH
```
